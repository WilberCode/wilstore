...
const StyledButton =    styled.button<{ $white?: boolean; $outline?: boolean;$default?: boolean;$full:boolean}>`${ButtonStyle}`

 
const Button = ({children,onClick,className,...rest}:any) => {
  return (
    <StyledButton onClick={onClick} {...rest} className={className} >{children}</StyledButton>
  )
}
